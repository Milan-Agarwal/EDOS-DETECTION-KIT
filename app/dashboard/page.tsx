    ...
    return (
      <div className="min-h-screen bg-black text-green-400 font-mono flex items-center justify-center">
        <div className="text-center">
          <div className="animate-pulse text-green-400 text-2xl mb-4">Loading dashboard...</div>
          <div className="text-green-600">$ initializing security interface...</div>
        </div>
      </div>
    );
  }
            ...
            <div className="flex items-center space-x-4">
              <div>
                ...
                <p className="text-sm text-green-600">
                  root@{user.username} | clearance: {user.role} | session: active
                </p>
              </div>
            </div>
            ...
            <Card className="bg-gray-900 border-green-500/30">
              <CardContent className="p-6">
                <div className="flex items-center justify-between">
                  ...
                  <div className="text-green-300 font-mono text-sm">Last update: {new Date().toLocaleTimeString()}</div>
                </div>
              </CardContent>
            </Card>
          </div>
